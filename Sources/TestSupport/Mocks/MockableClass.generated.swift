...
class SocketMock: Socket {
    ...
    override  func delegateOnError<T: AnyObject>(to owner: T, callback: @escaping (T, Error) -> Void) -> String {
        delegateOnErrorToCallbackCallsCount += 1
        return delegateOnErrorToCallbackReturnValue
    }
    ...
    static var buildEndpointUrlEndpointParamsClosureCallsCount = 0
    static var buildEndpointUrlEndpointParamsClosureCalled: Bool {
        return buildEndpointUrlEndpointParamsClosureCallsCount > 0
    }
    static var buildEndpointUrlEndpointParamsClosureReceivedArguments: (endpoint: String, params: PayloadClosure?)?
    static var buildEndpointUrlEndpointParamsClosureReturnValue: URL!
    static var buildEndpointUrlEndpointParamsClosureClosure: ((String, PayloadClosure?) -> URL)?

    override class func buildEndpointUrl(endpoint: String, paramsClosure params: PayloadClosure?) -> URL {
        buildEndpointUrlEndpointParamsClosureCallsCount += 1
    buildEndpointUrlEndpointParamsClosureReceivedArguments = (endpoint: endpoint, params: params)
        return buildEndpointUrlEndpointParamsClosureClosure.map({ $0(endpoint, params) }) ?? buildEndpointUrlEndpointParamsClosureReturnValue
    }
